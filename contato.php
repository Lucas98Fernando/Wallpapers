...
<div id="formcontact" class="container">
  <form action="/action_page.php" class="was-validated">
    ...
    <div class="form-group">
      ...
      <textarea rows="3" maxlength="500" class="form-control" id="message" placeholder="Descreva nesse campo as suas dúvidas, questionamentos, sugestões, entre outros..." name="pswd" required></textarea>
      <div class="valid-feedback">Válido.</div>
      <div class="invalid-feedback">Por favor, preencha esse campo para prosseguir.</div>
    </div>
